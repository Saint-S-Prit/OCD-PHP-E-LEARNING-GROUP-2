            ...
            <?php
                    ...
                    { 
                        ...
                        echo '<tr>';
                            ...
                            echo '<td class="numero">'.$_SESSION['donnees_recup']['numero'][$i].'</td>';
                            echo '<td>'.$_SESSION['donnees_recup']['genre'][$i].'</td>';
                            echo '<td>'.$_SESSION['donnees_recup']['satisfaction'][$i].'</td>';
                            echo '<td>';
                            foreach ($_SESSION['donnees_recup']['langue'][$i] as $key => $val)
                            {
                                 echo substr($val,0,1)." ";
                            }
                            echo '</td>';
